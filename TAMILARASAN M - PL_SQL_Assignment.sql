...
INSERT INTO ORDERS (ORDER_ID, CUSTOMER_ID, STATUS, SALESMAN_ID, ORDER_DATE) VALUES (1, 101, 'Shipped', 1, TO_DATE('2023-07-20', 'YYYY-MM-DD'));
INSERT INTO ORDERS (ORDER_ID, CUSTOMER_ID, STATUS, SALESMAN_ID, ORDER_DATE) VALUES (2, 102, 'Pending', 2, TO_DATE('2023-07-21', 'YYYY-MM-DD'));

INSERT INTO ORDER_ITEMS (ORDER_ITEM_ID, ORDER_ID, ITEM_ID, PRODUCT_ID, QUANTITY, UNIT_PRICE) VALUES (1, 1, 1, 1001, 2, 50.00);
INSERT INTO ORDER_ITEMS (ORDER_ITEM_ID, ORDER_ID, ITEM_ID, PRODUCT_ID, QUANTITY, UNIT_PRICE) VALUES (2, 1, 2, 1002, 1, 150.00);
INSERT INTO ORDER_ITEMS (ORDER_ITEM_ID, ORDER_ID, ITEM_ID, PRODUCT_ID, QUANTITY, UNIT_PRICE) VALUES (3, 2, 3, 1003, 3, 30.00);

CREATE VIEW SALES_REVENUES_BY_CUSTOMER AS
SELECT 
    o.CUSTOMER_ID,
...
SELECT * FROM SALES_REVENUES_BY_CUSTOMER;
